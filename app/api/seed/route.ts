...
const blogPosts = [
  {
    ...
    excerpt: "A behind-the-scenes look at how rasel.cloud delivered a full-scale multi-vendor marketplace with bKash/Nagad payment integration in just one month.",
