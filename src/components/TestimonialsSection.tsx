...
const testimonials = [
  ...
  },
  {
    ...
    text: {
      en: "Working with Rasel on our AI automation project was a game-changer. Delivered well beyond expectations.",
      bn: "আমাদের AI অটোমেশন প্রজেক্টে রাসেলের সাথে কাজ করা ছিল গেম-চেঞ্জার। প্রত্যাশার বাইরে ডেলিভারি করেছে।",
