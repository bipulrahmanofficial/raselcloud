...
const WA_MSG = encodeURIComponent("Hi rasel.cloud, I came from your website and would like to discuss a project.");
const TG_HANDLE = "raselcloud";
...
const DIRECT_CHANNELS = [
  ...
  },
  {
    ...
    href: "https://linkedin.com/company/rasel-cloud",
  ...
  },
  {
    ...
    href: "https://facebook.com/rasel.cloud",
  ...
  {
    label: "Email",
    subLabel: "hello@rasel.cloud",
    href: "mailto:hello@rasel.cloud",
