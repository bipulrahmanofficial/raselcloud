...
const faqs = [
  {
    q: "What services does rasel.cloud offer?",
  ...
  {
    q: "Is my data safe with rasel.cloud?",
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="text-center mb-10 animate-fade-in-up">
            ...
            <p className="text-muted-foreground mt-4 max-w-xl mx-auto">
              Everything you need to know about working with rasel.cloud. Can't find your answer? Contact us.
            </p>
          </div>
