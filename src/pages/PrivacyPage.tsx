...
const sections = [
  {
    ...
    body: `When you use rasel.cloud, we may collect: your name, email address, and phone number (provided during registration); Google account information (if you sign in with Google); project notes and order details; and technical data such as IP address, browser type, and usage analytics.`,
  },
  {
  ...
  },
  {
    ...
    body: `If you choose to sign in with Google, we receive your name, email address, and Google account ID. We only use this to create and authenticate your rasel.cloud account. We do not access your Google Drive, Gmail, or any other Google services.`,
  },
  {
  ...
  },
  {
    ...
    body: `rasel.cloud's services are not directed to children under 13. We do not knowingly collect personal data from children. If you believe a child has provided us with personal information, please contact us and we will delete it promptly.`,
  },
  {
          ...
          <div className="max-w-3xl mx-auto space-y-6 animate-fade-in-up">
            <div className="glass-card p-6 border-primary/30 bg-primary/5">
              <p className="text-sm text-muted-foreground">
                At rasel.cloud, your privacy matters. This policy explains what data we collect, how we use it, and how
